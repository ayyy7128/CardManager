...
- 新增首次启动使用向导，帮助用户快速了解卡包、任务、小金库和本地备份。
- 向导包含欢迎页、卡片视图交互、日历/小金库交互和本地优先说明。
- 向导支持左右滑动、上一步、下一步、跳过和开始使用。
- 完成或跳过后仅在本机记录完成状态。
- 设置页“关于”区域新增“使用向导”，可随时重新查看。
- 悬浮底部 Tab 调整为更紧凑的 58dp 高、72dp 单项宽布局。
- 四个 Tab 均可自由显示、隐藏和排序，至少保留一个。
- 更新弹窗可直接打开 GitHub Release 中的 APK 下载链接。
